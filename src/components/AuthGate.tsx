  ...
  if (!user) {
    return (
      <main className="mx-auto grid max-w-5xl gap-8 px-4 py-16 md:grid-cols-[1.2fr_0.8fr] md:items-center">
        <section>
          <p className="mb-3 text-sm font-bold uppercase tracking-[0.25em] text-ghibli-forest">Non-addictive project tracking</p>
          <h1 className="text-5xl font-black tracking-tight text-ghibli-deep">Keep your craft ideas, progress, and finished pieces in one calm place.</h1>
        ...
        <section className="rounded-3xl border border-stone-200 bg-white p-8 shadow-sm">
          <h2 className="text-2xl font-bold text-ghibli-deep">Sign in to start</h2>
          <p className="mt-2 text-stone-600">Use Google Sign-In so your projects can be saved in Firestore.</p>
          <button className="mt-6 w-full rounded-full bg-ghibli-deep px-5 py-3 font-semibold text-white hover:bg-ghibli-forest" onClick={signIn}>
